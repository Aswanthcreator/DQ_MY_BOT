...
<b>𝗜ᴀᴍ ᴀɴ ᴀᴡᴇꜱᴏᴍᴇ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ + ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ + ᴍᴀɴᴜᴀʟ ꜰɪʟᴛᴇʀ ʙᴏᴛ.</b>

<blockquote>𝗜 ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇꜱ ɪɴ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘꜱ.  
𝗬ᴏᴜ ᴄᴀɴ ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ɪɴ ʙᴏᴛ ᴘᴍ.  
𝗝ᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ꜱᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ ✨</blockquote>
...
🔹 ᴊᴏɪɴ ᴏᴜʀ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ.  
🔹 ᴀғᴛᴇʀ ᴊᴏɪɴɪɴɢ, ᴄʟɪᴄᴋ “ᴛʀʏ ᴀɢᴀɪɴ”.
    </b>"""
...
<b>╰─────────────────────⍟</b>"""
    ...
    EARN_INFO = """<b><blockquote><i>https://graph.org/file/b086470fb185ca49388e1-cffa4c648c87914166.jpg💸 ʜᴏᴡ ᴛᴏ ᴇᴀʀɴ ᴍᴏɴᴇʏ ʙʏ ᴛʜɪs ʙᴏᴛ - </blockquote>
...
ɪᴛ ʜᴀꜱ ᴇɪᴛʜᴇʀ ɴᴏᴛ ʙᴇᴇɴ ʀᴇʟᴇᴀꜱᴇᴅ ᴏʀ ʜᴀꜱ ɴᴏᴛ ʏᴇᴛ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ.</i></b>"""
    ...
    DISCLAIMER_TXT = """
<b><blockquote>Dɪꜱᴄʟᴀɪᴍᴇʀ ⊳</blockquote></b>
...
• /details - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴇᴛᴛɪɴɢꜱ."""    
    ...
    SOURCE_TXT = """<b><blockquote>Sᴏᴜʀᴄᴇ Cᴏᴅᴇ ⊳</blockquote></b>
...
🖥 **𝑶𝑺** .......... {os}
🤖 **𝑩𝒐𝒕 𝑼𝒑𝒕𝒊𝒎𝒆** ... {bot_uptime}
🔄 **𝑯𝒐𝒔𝒕 𝑼𝒑𝒕𝒊𝒎𝒆** .. {system_uptime}

🧬 **𝑹𝑨𝑴 𝑼𝒔𝒂𝒈𝒆** .... {used_ram} / {total_ram}
💽 **𝑫𝒊𝒔𝒌 𝑺𝒑𝒂𝒄𝒆** ... {used_disk} / {total_disk}

📡 **𝑹𝒆𝒔𝒑𝒐𝒏𝒔𝒆 𝑻𝒊𝒎𝒆:** {latency}
"""
