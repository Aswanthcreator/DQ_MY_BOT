...
BOT_TOKEN = environ.get('BOT_TOKEN', "8203969661:AAG9bNeK8HAqPyszv3k2Yl6rxIfRKYD9xyU")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8587405600').split()] 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003408919601 -1003370992067').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DQ_DB1:DQ_DB11@cluster0.1pxwbbu.mongodb.net/?appName=Cluster0")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://DQ_DB2:DQ_DB22@cluster0.gf6cxly.mongodb.net/?appName=Cluster0")
...
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1001681286512') # add multiple channels here, separated by single space
