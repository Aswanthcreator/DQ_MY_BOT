...
async def start(client, message):
    ...
    if data.startswith("allfiles"):
        ...
        for file in files:
            ...
            if STREAM_MODE:
                btn = [
                    [InlineKeyboardButton('', callback_data=f'streamfile:{file_id}')],
                    [InlineKeyboardButton('𝖦𝖾𝗇𝖾𝗋𝖺𝗍𝖾 𝖲𝗍𝗋𝖾𝗆𝗂𝗇𝗀 𝖫𝗂𝗇𝗄', url=UPDATE_CHANNEL_LNK)]  
                ]
            else:
                btn = [
    ...
    if not files_:
        ...
        try:
            if STREAM_MODE:
                btn = [
                    [InlineKeyboardButton('', callback_data=f'streamfile:{file_id}')],
                    [InlineKeyboardButton('𝖦𝖾𝗇𝖾𝗋𝖺𝗍𝖾 𝖲𝗍𝗋𝖾𝗆𝗂𝗇𝗀 𝖫𝗂𝗇𝗄𝗅', url=UPDATE_CHANNEL_LNK)]
